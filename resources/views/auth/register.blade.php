<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-8 pt-4 border-t border-slate-200">
            ...
            <x-text-input id="admin_code" class="block mt-1 w-full border-indigo-300 focus:border-indigo-500 focus:ring-indigo-500" type="password" name="admin_code" autocomplete="off" />
        </div>
